# Step 12 — Populate Jira board with Epics + Tasks (`board-nanny`)
...
Agent({
  ...
  prompt: "The tech spec at spec/tech-spec.md is approved. Jira project: <KEY>, board: <NN>, cloudId: <YOUR_ORG>.atlassian.net. Begin Phase 1 — draft Epics for operator review. Do not write to Jira yet."
})
```
...
- **Don't let the agent skip the approval gates.** Phases 1 and 2 are operator-review gates by design. Don't shortcut them.
...
Board is populated, operator nods at the result. Move to step 13.
